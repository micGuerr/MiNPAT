function status = dcm2nii(dcmdir_path, dcm_subID, dcm_sesID, configFile, outpdir_path, subID, sesID)
% 
...
if ischar(dcm_sesID) % if char, assumes single folder for this timepoint
    ...
    % Run Conversion
    status = dcmConvert(inDicom, subID, sesID, configFile, outpdir_path);
